========================================================================
    KONSOLENANWENDUNG: CppImplicitCasting-Projektübersicht
========================================================================

Diese CppImplicitCasting-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre CppImplicitCasting-Anwendung besteht.


CppImplicitCasting.vcxproj
...
CppImplicitCasting.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen CppImplicitCasting.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
